...
export const defaultRatingCopy: RatingCopy = {
  ...
  private_prompt_body:
    "Tu mensaje llega a la persona adecuada. No se publica en Google ni en ningún sitio.",
  ...
  recovery_hint:
    "Si quieres hablar con un encargado, deja tu teléfono o email en el mensaje.",
